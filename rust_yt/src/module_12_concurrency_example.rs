...
pub fn thread_with_move_example() {
    let block_data = vec![1001, 1002, 1003, 1004, 1005];
...
async fn blockchain_task(id: u8, duration: u64) {
    println!("Blockchain Task {} started, waiting for {} seconds ...", id, duration);
...
pub fn thread_with_channels_example() {
    ...
    let handle = thread::spawn(move || {
        let messages = vec![
            String::from("Block101"),
            String::from("Block102"),
            String::from("Block103")
        ];
